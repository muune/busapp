...
public class ParserGongju extends CommonParser {


    public ParserGongju(SQLiteDatabase db) {
        super(db);
    }
    ...
    public DepthStopItem getStopList(BusRouteItem rItem) {
        ...
        String selectBusStopQry = String.format("SELECT %s,%s FROM %s where %s='%s'", CommonConstants.BUS_ROUTE_RELATED_STOPS, CommonConstants.BUS_ROUTE_TURN_STOP_IDX, CommonConstants.CITY_GONG_JU._engName + "_Route",
        ...
        if (cursor.moveToNext()) {
            ...
            for (int i = 0; i < ids.length; i++) {
                ...
                String stopQry = String.format("SELECT * From %s where %s=%s", CommonConstants.CITY_GONG_JU._engName + "_Stop",
                ...
                if (stopCursor.moveToNext()) {
                    ...
                    stopItem.localInfoId = String.valueOf(CommonConstants.CITY_GONG_JU._cityId);
    ...
    public DepthRouteItem getLineList(BusStopItem sItem) {
        ...
        String url = "http://bis.gongju.go.kr/inq/searchBusStopRoute.do";
        ...
        if (parseStr != null) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    routeItem.localInfoId = String.valueOf(CommonConstants.CITY_GONG_JU._cityId);
    ...
    public DepthStopItem getDepthStopList(DepthStopItem sItem) {
        ...
        String htmlResult = RequestCommonFuction.getSource("http://bis.gongju.go.kr/inq/searchBusRealLocationDetail.do", true, "busRouteId=" + sItem.tempId, "utf-8");
