...
public class ParserMuan extends CommonParser {


    public ParserMuan(SQLiteDatabase db) {
        super(db);
    }
    ...
    public DepthStopItem getStopList(BusRouteItem rItem) {
        ...
        String selectBusStopQry = String.format("SELECT %s,%s FROM %s where %s='%s'", CommonConstants.BUS_ROUTE_RELATED_STOPS, CommonConstants.BUS_ROUTE_TURN_STOP_IDX, CommonConstants.CITY_MUAN._engName + "_Route",
        ...
        if (cursor.moveToNext()) {
            ...
            for (int i = 0; i < ids.length; i++) {
                ...
                String stopQry = String.format("SELECT * From %s where %s=%s", CommonConstants.CITY_MUAN._engName + "_Stop",
                ...
                if (stopCursor.moveToNext()) {
                    ...
                    stopItem.localInfoId = String.valueOf(CommonConstants.CITY_MUAN._cityId);
    ...
    public DepthRouteItem getLineList(BusStopItem sItem) {
        ...
        String url = "http://bis.mokpo.go.kr/ma/bis/searchBusStopRoute.do";
        ...
        if (parseStr != null) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    routeItem.localInfoId = String.valueOf(CommonConstants.CITY_MUAN._cityId);
    ...
    public DepthStopItem getDepthStopList(DepthStopItem sItem) {
        ...
        String htmlResult = RequestCommonFuction.getSource("http://bis.mokpo.go.kr/ma/bis/searchBusRealLocationDetail.do", true, "busRouteId=" + sItem.tempId, "utf-8");
