...
public class SubAdlibAdViewAdmixer extends SubAdlibAdViewCore {
    ...
    protected String admixerID = "7uubhzmo";
...
//		ad.setAdapterOption(AdAdapter.ADAPTER_CAULY, "allow_call", "yes"); // Cauly 콜 광고 여부 설정
        ...
        ad.setAdapterOption(AdAdapter.ADAPTER_ADMIXER_RTB_NCPI, "bannerHeight", "fixed");
        ad.setAdapterOption(AdAdapter.ADAPTER_INMOBI, "bannerHeight", "fixed", InmobiAdapter.INMOBI_AD_UNIT_320X50);
        ad.setAdapterOption(AdAdapter.ADAPTER_CAULY, "bannerHeight", "fixed", "Fixed_50");
