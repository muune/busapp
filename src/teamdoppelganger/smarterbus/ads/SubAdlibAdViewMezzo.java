...
public class SubAdlibAdViewMezzo extends SubAdlibAdViewCore {
    ...
    protected String publisherCode = "1313";
    protected String mediaCode = "30867";
    protected String sectionCode = "802013";
    ...
    private String getErrorCode(int msg) {
        ...
        switch (msg) {
            ...
            case -100:
                errMessage = "Network 에러";
                break;
            case -200:
                errMessage = "광고 서버 에러";
                break;
            case -300:
                errMessage = "API 타입 오류";
                break;
            case -400:
                errMessage = "App ID 값 오류";
                break;
            case -500:
                errMessage = "Window ID 값 오류";
                break;
            case -600:
                errMessage = "해당 ID 값이 정상적이지 않음";
                break;
            case -700:
                errMessage = "해당 ID의 광고가 존재하지 않음";
                break;
            case -800:
                errMessage = "예기치 못한 예외 발생";
                break;
            case -900:
                errMessage = "해당 광고소재 오류";
                break;
            case -1000:
                errMessage = "설정된 interval시간에 걸려서 광고 호출 제외";
                break;
            case -2000:
                errMessage = "3D광고 일 때 미지원 이벤트";
                break;
        }
